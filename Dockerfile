...
ENV BLENDER_MAJOR 2.79b
ENV BLENDER_VERSION 2.79
ENV BLENDER_HOME /usr/local/blender

RUN mkdir $BLENDER_HOME && \
    curl -SL "https://download.blender.org/release/Blender$BLENDER_VERSION/blender-$BLENDER_MAJOR-linux-glibc219-x86_64.tar.bz2" -o blender.tar.bz2 && \
